...
from transformers import AutoModelForSeq2SeqLM, AutoTokenizer, T5ForConditionalGeneration, AdamW, Seq2SeqTrainer, TrainingArguments, Seq2SeqTrainingArguments, BartForConditionalGeneration
import torch
import numpy as np
import evaluate
...
# Change to "facebook/bart-large" and use tokenizer from custom_tokenizers/bart_large_full 
config = AutoConfig.from_pretrained("facebook/bart-base")
config.vocab_size = 33699
model = BartForConditionalGeneration(config)
model.config.max_length = 256

tokenizer = AutoTokenizer.from_pretrained('custom_tokenizers/BART-small-custom_full_33699')

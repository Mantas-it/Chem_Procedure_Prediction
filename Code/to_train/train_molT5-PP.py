...
# Change to 'laituan245/molt5-base-smiles2caption' or 'laituan245/molt5-small-smiles2caption' for other size models

model = T5ForConditionalGeneration.from_pretrained('laituan245/molt5-large-smiles2caption')
tokenizer = AutoTokenizer.from_pretrained('laituan245/molt5-large-smiles2caption', model_max_length=512)
